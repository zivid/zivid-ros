...
ZIVID_RELEASE_DIR="https://downloads.zivid.com/sdk/previews/$CI_TEST_ZIVID_VERSION"
...
if [[ "$UBUNTU_VERSION" == "18.04" ]]; then
    ...
    install_www_deb "$ZIVID_RELEASE_DIR/u20/amd64/zivid_${CI_TEST_ZIVID_VERSION}_amd64.deb" || exit $?
