...
{
public:
  HandEyeCalibration(const rclcpp::NodeOptions & options)
  : Node("hand_eye_calibration_node", options),
    m_save_directory{
    ...
    m_capture_service{create_service<std_srvs::srv::Trigger>(
      ...
      std::bind(
        &HandEyeCalibration::capture_callback, this, std::placeholders::_1, std::placeholders::_2),
    ...
    m_calibrate_service{create_service<std_srvs::srv::Trigger>(
      ...
      std::bind(
        &HandEyeCalibration::calibrate_callback, this, std::placeholders::_1,
        std::placeholders::_2),
      default_rclcpp_services_qos, m_callback_group)}
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(zivid_component::HandEyeCalibration)
